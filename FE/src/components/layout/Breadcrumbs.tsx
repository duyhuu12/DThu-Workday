...
const LABEL_MAP: Record<string, string> = {
  student: 'Sinh viên', classleader: 'Cán bộ lớp', organizer: 'Người phụ trách', admin: 'Quản trị viên', superadmin: 'Super Admin',
  ...
  reminders: 'Nhắc ngày công', announcements: 'Gửi thông báo lớp', 'class-leaders': 'Cán bộ lớp',
};
...
const ROLE_HOME_MAP: Record<string, string> = {
  ...
  classleader: '/classleader/dashboard',
