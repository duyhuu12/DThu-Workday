...
import { EVENT_STATUS_LABELS, EVENT_STATUS_VARIANTS, REG_STATUS_LABELS } from '@/lib/constants';
...
export default function OrganizerDashboard() {
  ...
  return <div className="space-y-6">
    ...
    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <StatCard title="Tổng lượt sinh viên đăng ký" value={myRegs.length} icon={Users} iconClassName="bg-warning/10 text-warning" />
      <StatCard title="SV chờ kết quả" value={approved.length} icon={Clock} iconClassName="bg-success/10 text-success" />
      <StatCard title="Sự kiện đã hoàn thành" value={completedEvents.length} icon={CheckCircle2} iconClassName="bg-secondary/10 text-secondary" />
    </div>
