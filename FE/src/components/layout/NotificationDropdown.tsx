...
export function NotificationDropdown() {
  ...
  return <DropdownMenu>
    ...
    <DropdownMenuContent align="end" className="w-80 p-0">
      ...
      <div className="border-t p-2"><Button asChild variant="ghost" size="sm" className="w-full text-xs"><Link href={`/${currentUser.role}/notifications`}>Xem tất cả</Link></Button></div>
    </DropdownMenuContent>
  </DropdownMenu>;
}
