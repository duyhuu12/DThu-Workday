...
import { getCredits, adjustCredit, updateCreditStatus, createManualCredit } from '../controllers/creditController.js';
import { authenticate, authorize } from '../middlewares/auth.js';

const router = Router();

router.get('/', authenticate, getCredits);
router.post('/manual', authenticate, authorize(['ADMIN', 'SUPER_ADMIN']), createManualCredit);
