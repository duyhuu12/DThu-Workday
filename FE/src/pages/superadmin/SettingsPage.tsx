...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Cài đặt hệ thống" description="Cấu hình hệ thống DThU Workday và học kỳ tác nghiệp" />
        ...
        <CardContent className="p-0">
          {semesterConfigs.length === 0 ? (
            <div className="p-8 text-center text-sm text-muted-foreground">
              Chưa có cấu hình học kỳ nào. Hãy nhấn "Thêm học kỳ" để tạo mới.
            </div>
          ) : (
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            <Label>Ngày công yêu cầu mặc định</Label>
            <Input
              type="number"
              min={1}
          ...
          <div className="flex items-center justify-between rounded-lg border p-4">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                setForm((f) => ({ ...f, maintenanceMode: checked }))
              }
            />
          </div>
        </CardContent>
