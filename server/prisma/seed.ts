import { PrismaClient, UserRole, AccountStatus, WorkShift, EventStatus, RegistrationStatus, AttendanceStatus, CreditStatus, ComplaintType, ComplaintStatus, ComplaintPriority, NotificationType } from '@prisma/client';
...
async function main() {
  ...
  // 5. Users
  // Mật khẩu hash cho '123456' sử dụng plain text hoặc bcrypt (ở đây để text để đơn giản hoặc dùng bcrypt nếu cần)
  // Để đồng bộ với authentication chúng ta sẽ dùng bcrypt. Mật khẩu 123456 hashed: '$2b$10$tJ20Jj/6Jk6.C7qT0WjVf.U.6o.hUu4hU5gD5sT7uF8g9h1m2n3o.'
  const passHash = '$2b$10$.NmxJi4YrLYZMHQU4trstOynvH8CvjHaKS29VPxObhh1H7EiBgKwO'; // hash of '123456'
