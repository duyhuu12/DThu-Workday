...
import {
  ...
  getSettings, updateSettings, getSemesters, createSemester, updateSemester, activateSemester, deleteSemester,
  getActivityLogs,
...
router.get('/students', authenticate, authorize([...admins]), getStudents);
...
router.post('/semesters', authenticate, authorize(['SUPER_ADMIN']), createSemester);
router.put('/semesters/:id', authenticate, authorize(['SUPER_ADMIN']), updateSemester);
router.put('/semesters/:id/activate', authenticate, authorize(['SUPER_ADMIN']), activateSemester);
router.delete('/semesters/:id', authenticate, authorize(['SUPER_ADMIN']), deleteSemester);
